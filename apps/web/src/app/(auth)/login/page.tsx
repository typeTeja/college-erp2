    ...
    return (
        <div className="bg-white p-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:w-full sm:max-w-md sm:rounded-lg">
            ...
            <div className="mt-6 border-t border-gray-100 pt-6 text-center">
                <h3 className="text-sm font-semibold text-gray-900">New Applicant?</h3>
                <div className="mt-3">
                    <Link href="/apply">
                        <button
                            type="button"
                            className="w-full rounded-md bg-white px-3 py-2 text-sm font-semibold text-indigo-600 shadow-sm ring-1 ring-inset ring-indigo-200 hover:bg-indigo-50 transition-colors"
                        >
                            Apply for Admission
                        </button>
                    </Link>
