...
class EasebuzzService:
    ...
    async def initiate_payment(self, payment_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        payload = {
            ...
            "surl": payment_data.get('surl') or f'{settings.BACKEND_BASE_URL}/api/v1/payment/response',
            "furl": payment_data.get('furl') or f'{settings.BACKEND_BASE_URL}/api/v1/payment/response',
            "hash": hash_value,
