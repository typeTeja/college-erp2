...
from app.domains.academic.models import (
    Regulation, RegulationSubject, RegulationSemester,
    AcademicBatch, BatchSubject, BatchSemester, ProgramYear
)
...
from app.domains.academic.services.bulk_setup_service import BulkBatchSetupService
from app.domains.academic.services.batch_cloning_service import BatchCloningService
