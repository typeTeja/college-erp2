"""
Finance Domain Models - Fee Management

Models for fee structures, student fees, payments, concessions, and fines.
"""
...
class FeeStructure(SQLModel, table=True):
    """Fee structure per program, year, and category"""
...
class FeeConcession(SQLModel, table=True):
    """Fee concessions/discounts for students"""
...
class StudentFeeInstallment(SQLModel, table=True):
    """Student-specific installment tracking"""
